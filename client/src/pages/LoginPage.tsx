    ...
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-4 py-16">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="mt-10 space-y-5">
        ...
        <div className="flex justify-end">
          <Link to="/forgot-password" className="text-sm text-muted-foreground hover:text-foreground">{t('auth.forgotPassword')}</Link>
        </div>
        <Button type="submit" size="lg" fullWidth isLoading={loading}>{t('auth.login')}</Button>
      </form>
