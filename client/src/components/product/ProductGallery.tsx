    ...
    <div className="space-y-4">
      ...
      <div className="relative aspect-[3/4] overflow-hidden rounded-2xl bg-muted">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <span className="font-display text-6xl font-semibold text-foreground/5 select-none">
            FIVE
          </span>
        </div>
      </div>
        ...
        {slides.map((i) => (
          <button
            ...
            className={`
              ...
              ${activeIndex === i ? 'ring-2 ring-accent ring-offset-2 ring-offset-background' : 'opacity-70 hover:opacity-100'}
            `}
