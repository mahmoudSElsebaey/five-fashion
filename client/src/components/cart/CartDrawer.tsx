...
/** SECTION 07 — Cart drawer with a11y, empty state, qty controls */
export function CartDrawer() {
  ...
  return (
    <div className="fixed inset-0 z-[60]" role="presentation">
      ...
      <div
        className="absolute inset-y-0 end-0 flex w-full max-w-md flex-col bg-background shadow-xl"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        {items.length === 0 ? (
          <div className="flex flex-1 flex-col items-center justify-center gap-4 px-6 text-center" role="status">
            <p className="text-muted-foreground">{t('cart.empty')}</p>
            <Button variant="outline" onClick={goShop}>
          ...
          <>
            ...
            <div className="space-y-4 border-t border-border px-5 py-5">
              ...
              <Button variant="outline" size="lg" fullWidth onClick={goShop}>
                {t('cart.continueShopping')}
              </Button>
            </div>
          </>
