        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          <div className="space-y-4 md:col-span-1">
            <Link to="/" className="inline-flex items-center" aria-label="FIVE Fashion home">
              <img src="/logo.png" alt="FIVE Fashion" className="h-21 w-auto max-w-[210px] object-contain drop-shadow-[2px_3px_rgba(0,0,0,0.65)] dark:drop-shadow-none sm:h-24 sm:max-w-[240px]" />
            </Link>
          ...
          <div>
            <h4 className="mb-4 text-sm font-semibold tracking-wide text-foreground">{t('footer.shop')}</h4>
          ...
          <div>
            <h4 className="mb-4 text-sm font-semibold tracking-wide text-foreground">{t('footer.support')}</h4>
            <ul className="space-y-2.5 text-sm text-muted-foreground">
          ...
          <div>
            <h4 className="mb-4 text-sm font-semibold tracking-wide text-foreground">{t('footer.newsletter')}</h4>
