  ...
  en: {
    translation: {
      ...
      shop: {
        ...
        gender: { all: 'All', women: 'Women', men: 'Men', unisex: 'Unisex' },
        sort: {
          label: 'Sort by',
          newest: 'Newest',
      ...
      auth: {
        ...
        forgotSuccess: 'If an account exists, a reset link has been sent',
        forgotError: 'Could not start password reset',
        devTokenHint: 'Development only — use this link to reset:',
        ...
        resetMissingToken: 'Reset link is missing or invalid',
      ...
      product: {
        ...
        descriptionPlaceholder: 'A refined piece crafted with exceptional attention to detail.',
        view3d: '3D View',
      ...
      admin: {
        ...
        nav: { dashboard: 'Dashboard', products: 'Products', orders: 'Orders' },
        dashboard: {
          title: 'Dashboard',
  ...
  ar: {
    translation: {
      ...
      shop: {
        ...
        gender: { all: 'الكل', women: 'نساء', men: 'رجال', unisex: 'للجنسين' },
        sort: {
          label: 'ترتيب حسب',
          newest: 'الأحدث',
      ...
      auth: {
        ...
        forgotSuccess: 'إذا وُجد حساب، تم إرسال رابط إعادة التعيين',
        forgotError: 'تعذر بدء إعادة التعيين',
        devTokenHint: 'للتطوير فقط — استخدم هذا الرابط:',
        continueToReset: 'المتابعة لإعادة التعيين',
        resetTitle: 'اختر كلمة مرور جديدة',
        resetSubtitle: 'أدخل كلمة المرور الجديدة وأكدها',
        resetSubmit: 'تحديث كلمة المرور',
        resetSuccess: 'تم التحديث. يمكنك تسجيل الدخول الآن.',
        ...
        profileUpdateError: 'تعذر تحديث الملف',
        myOrders: 'طلباتي',
      },
      product: {
        ...
        added: 'تمت الإضافة',
        reviews: '{{count}} تقييم',
        descriptionPlaceholder: 'قطعة راقية صُنعت بعناية فائقة.',
      ...
      admin: {
        ...
        nav: { dashboard: 'لوحة التحكم', products: 'المنتجات', orders: 'الطلبات' },
        dashboard: {
          title: 'لوحة التحكم',
