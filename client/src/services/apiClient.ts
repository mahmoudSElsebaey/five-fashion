...
export const wishlistApi = {
  ...
  add: (productId: string) => apiRequest<unknown>('/wishlist/items', { method: 'POST', body: JSON.stringify({ productId }) }, true),
  remove: (productId: string) => apiRequest<unknown>(`/wishlist/items/${productId}`, { method: 'DELETE' }, true),
...
export const couponsApi = {
  ...
  remove: (id: string) => apiRequest<unknown>(`/coupons/${id}`, { method: 'DELETE' }, true),
};

export const addressesApi = {
  list: () => apiRequest<unknown[]>('/addresses', {}, true),
  create: (body: unknown) => apiRequest<unknown>('/addresses', { method: 'POST', body: JSON.stringify(body) }, true),
  update: (id: string, body: unknown) => apiRequest<unknown>(`/addresses/${id}`, { method: 'PATCH', body: JSON.stringify(body) }, true),
  remove: (id: string) => apiRequest<unknown>(`/addresses/${id}`, { method: 'DELETE' }, true),
  setDefault: (id: string) => apiRequest<unknown>(`/addresses/${id}/default`, { method: 'POST' }, true),
};
